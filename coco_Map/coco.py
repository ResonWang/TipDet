...
class COCO:
    ...
    def loadRes(self, resFile, use_ext=False):
        ...
        # print("set(annsImgIds),set(self.getImgIds()):", set(annsImgIds),set(self.getImgIds()))
        assert set(annsImgIds) == (set(annsImgIds) & set(self.getImgIds())), \
               'Results do not correspond to current coco set'                   # 2196 4195 有80个在dr但不在gt中 集合a和b中都包含了的元素，即获取的id不能超过标注id以外  set(annsImgIds)检测到的图片名，set(self.getImgIds())标注的图片名
